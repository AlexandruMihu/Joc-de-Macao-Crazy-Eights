...
namespace december_3rd_client
{
    public class Carte
    {
        ...
        public Carte(VALOARE valoareCarte1, SIMBOL simbolCarte1)
        {
            ...
            this.imagineCarte.Image =  Image.FromFile("E:\\Proiect POO Mihu Alexandru-Ioan\\december 3rd client\\Resources\\" + numeCarte + ".png");
        ...
        public Carte(Carte c)
        {
            ...
            this.imagineCarte.Image = Image.FromFile("E:\\Proiect POO Mihu Alexandru-Ioan\\december 3rd client\\Resources\\" + c.numeCarte + ".png");
        }
